...
import { fetchBusinesses, fetchCatalog, fetchContests, fetchOffers, fetchServices } from './catalogApi.js';
...
let SHOP_VIEWS = {
  home: ['hero', 'offers', 'contests', 'shop-services', 'shop-products', 'about', 'contact'],
  offers: ['offers'],
  contests: ['contests'],
