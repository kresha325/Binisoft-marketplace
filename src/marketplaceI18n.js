...
const STRINGS = {
  ...
  de: {
    ...
    statContests: 'Wettbewerbe',
    tabStores: 'Shops',
    tabProducts: 'Produkte',
    tabCategories: 'Kategorien',
    tabOffers: 'Angebote',
    tabContests: 'Wettbewerbe',
    ...
    emptyContests: 'Keine aktiven Wettbewerbe.',
